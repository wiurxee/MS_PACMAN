...
public final class Constants
{
	...
	public static final float GHOST_REVERSAL=0f;		//probability of a global ghost reversal event	
	...
	public static final int DELAY=50;						//delay (in milliseconds) between game advancements						
